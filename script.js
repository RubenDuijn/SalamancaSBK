...
const scheduleDataEn = [
  {
    day: 'Monday',
    focus: 'Open Level + Salsa/Bachata',
    classes: [
      ...
      { title: 'Salsa en Linea On1 + Rueda Level 1-2', time: '22:00' },
    ],
  },
  {
    day: 'Tuesday',
  ...
  {
    day: 'Wednesday',
    focus: 'Salsa Track + Zouk',
    classes: [
      { title: 'Zouk Foundations (Free Slot)', time: '17:00' },
      { title: 'Salsa Cubana + Rueda Casino Level 1', time: '20:00' },
      { title: 'Salsa en Linea On1 + Shines On2', time: '21:00' },
      { title: 'Salsa Cubana + Rueda Casino Level 1-2', time: '22:00' },
    ],
  },
  {
    day: 'Thursday',
    focus: 'Salsa + Kizomba + Tango',
    classes: [
      { title: 'Salsa Cubana Level 0-1', time: '16:00' },
      { title: 'Salsa Cubana + Rueda Casino Level 1', time: '17:00' },
      { title: 'Tango Argentino Level 0-1', time: '18:00' },
      { title: 'Bachata Moderna Level 0-1', time: '20:00' },
      { title: 'Kizomba + Bachata Dominicana Level 1-2', time: '21:00' },
      { title: 'Kizomba Flow Fusion Level 1-2', time: '22:00' },
    ],
  },
  {
    day: 'Friday',
    focus: 'Bachata + Open Practice',
    classes: [
      { title: 'Bachata Moderna Level 0', time: '18:00' },
      { title: 'Bachata Dominicana + Rueda Casino Level 1', time: '20:00' },
...
const scheduleDataEs = [
  {
    ...
    classes: [
      ...
      { title: 'Salsa en Linea On1 + Rueda Nivel 1-2', time: '22:00' },
    ],
  },
  {
    day: 'Martes',
    focus: 'Ruta de Bachata',
    classes: [
  ...
  {
    day: 'Miercoles',
    focus: 'Ruta de Salsa + Zouk',
    classes: [
      { title: 'Zouk Foundations (Hueco libre)', time: '17:00' },
      { title: 'Salsa Cubana + Rueda Casino Nivel 1', time: '20:00' },
      { title: 'Salsa en Linea On1 + Shines On2', time: '21:00' },
      { title: 'Salsa Cubana + Rueda Casino Nivel 1-2', time: '22:00' },
    ],
  },
  {
    day: 'Jueves',
    ...
    classes: [
      ...
      { title: 'Salsa Cubana + Rueda Casino Nivel 1', time: '17:00' },
      { title: 'Tango Argentino Nivel 0-1', time: '18:00' },
      { title: 'Bachata Moderna Nivel 0-1', time: '20:00' },
      { title: 'Kizomba + Bachata Dominicana Nivel 1-2', time: '21:00' },
      { title: 'Kizomba Flow Fusion Nivel 1-2', time: '22:00' },
    ],
  },
  {
    day: 'Viernes',
    focus: 'Bachata + practica abierta',
    classes: [
      { title: 'Bachata Moderna Nivel 0', time: '18:00' },
      { title: 'Bachata Dominicana + Rueda Casino Nivel 1', time: '20:00' },
  ...
  {
    day: 'Sabado',
    focus: 'Noche social de comunidad',
    classes: [
